...
struct SizeHelper {
    ...
    static func getMedium() -> CGSize {
        let s = UIScreen.main.bounds
        let res = mediumMap[.init(width: s.width, height: s.height)] ?? CGSize(width: 321, height: 148)
//        Logging.bg.debug("getMedium \(res.debugDescription)")
        return res
    }
    ...
    static func buildSmallWidgetSize() -> Dictionary<ScreenSize, CGSize> {
        var mp = Dictionary<ScreenSize, CGSize>()
    ...
    static func buildMediumWidgetSize() -> Dictionary<ScreenSize, CGSize> {
        var mp = Dictionary<ScreenSize, CGSize>()
    ...
    static func buildLargeWidgetSize() -> Dictionary<ScreenSize, CGSize> {
        var mp = Dictionary<ScreenSize, CGSize>()
